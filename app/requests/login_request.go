...
type LoginByPasswordRequest struct {
	...
	LoginID  string `form:"login_id" valid:"login_id" json:"login_id" `
	Password string `form:"password" valid:"password" json:"password,omitempty"`
}
...
// LoginByPassword 验证表单  返回长度等于零通过
